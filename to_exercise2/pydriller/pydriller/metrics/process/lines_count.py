...
from to_exercise2.pydriller.pydriller import ModificationType
from to_exercise2.pydriller.pydriller.metrics.process.process_metric import ProcessMetric
    ...
    def _initialize(self):
        ...
        for commit in self.repo_miner.traverse_commits():
            ...
            for modified_file in commit.modified_files:
                ...
                self.lines_added.setdefault(filepath, []).append(modified_file.added_lines_without_blank_and_comments)
                self.lines_removed.setdefault(filepath, []).append(modified_file.deleted_lines_without_blank_and_comments)
