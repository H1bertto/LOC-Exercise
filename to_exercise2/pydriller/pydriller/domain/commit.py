...
from to_exercise2.pydriller.pydriller.domain.developer import Developer
...
class ModifiedFile:
    ...
    @property
    def added_lines_without_blank_and_comments(self) -> int:
        """
        Return the total number of added lines in the file.
    ...
    @property
    def deleted_lines_without_blank_and_comments(self) -> int:
        """
        Return the total number of deleted lines in the file.
